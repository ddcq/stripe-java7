...
public class OrderUpdateParams extends ApiRequestParams {
  ...
  private OrderUpdateParams(String coupon, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata, String selectedShippingMethod, Shipping shipping, Status status) {
    this.coupon = coupon;
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public OrderUpdateParams build() {
      return new OrderUpdateParams(this.coupon, this.expand, this.extraParams, this.metadata, this.selectedShippingMethod, this.shipping, this.status);
    }
  ...
  public enum Status implements ApiRequestParams.EnumParam {
    ...
    CANCELED("canceled"), @SerializedName("created")
    CREATED("created"), @SerializedName("fulfilled")
    FULFILLED("fulfilled"), @SerializedName("paid")
    PAID("paid"), @SerializedName("returned")
    RETURNED("returned");
