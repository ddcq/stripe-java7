...
public class SubscriptionScheduleCreateParams extends ApiRequestParams {
  ...
  private SubscriptionScheduleCreateParams(Billing billing, Object billingThresholds, CollectionMethod collectionMethod, String customer, String defaultPaymentMethod, String defaultSource, List<String> expand, Map<String, Object> extraParams, String fromSubscription, InvoiceSettings invoiceSettings, Map<String, String> metadata, List<Phase> phases, RenewalBehavior renewalBehavior, RenewalInterval renewalInterval, Object startDate) {
  ...
  public static class Phase {
    ...
    private Phase(BigDecimal applicationFeePercent, String coupon, Object defaultTaxRates, Long endDate, Map<String, Object> extraParams, Long iterations, List<Plan> plans, BigDecimal taxPercent, Boolean trial, Long trialEnd) {
    ...
    public static class Builder {
       ...
       */
      public Phase build() {
        return new Phase(this.applicationFeePercent, this.coupon, this.defaultTaxRates, this.endDate, this.extraParams, this.iterations, this.plans, this.taxPercent, this.trial, this.trialEnd);
      }
