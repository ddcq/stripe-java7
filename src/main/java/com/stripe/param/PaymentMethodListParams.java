...
public class PaymentMethodListParams extends ApiRequestParams {
  ...
  private PaymentMethodListParams(String customer, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String startingAfter, Type type) {
  ...
  public static class Builder {
    ...
    public PaymentMethodListParams build() {
      return new PaymentMethodListParams(this.customer, this.endingBefore, this.expand, this.extraParams, this.limit, this.startingAfter, this.type);
    }
