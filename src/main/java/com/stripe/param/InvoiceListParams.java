...
public class InvoiceListParams extends ApiRequestParams {
  ...
  private InvoiceListParams(Billing billing, CollectionMethod collectionMethod, Object created, String customer, Object dueDate, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String startingAfter, Status status, String subscription) {
  ...
  public static class Builder {
    ...
    public InvoiceListParams build() {
      return new InvoiceListParams(this.billing, this.collectionMethod, this.created, this.customer, this.dueDate, this.endingBefore, this.expand, this.extraParams, this.limit, this.startingAfter, this.status, this.subscription);
    }
