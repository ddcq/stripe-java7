...
public class ExternalAccountUpdateParams extends ApiRequestParams {
  ...
  private ExternalAccountUpdateParams(String accountHolderName, ApiRequestParams.EnumParam accountHolderType, String addressCity, String addressCountry, String addressLine1, String addressLine2, String addressState, String addressZip, Boolean defaultForCurrency, String expMonth, String expYear, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata, String name) {
