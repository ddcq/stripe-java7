...
public class CustomerUpdateParams extends ApiRequestParams {
  ...
  private CustomerUpdateParams(Long accountBalance, Object address, Long balance, String coupon, String defaultSource, String description, String email, List<String> expand, Map<String, Object> extraParams, String invoicePrefix, InvoiceSettings invoiceSettings, Map<String, String> metadata, String name, String phone, List<String> preferredLocales, Object shipping, String source, ApiRequestParams.EnumParam taxExempt, TaxInfo taxInfo, Object trialEnd) {
