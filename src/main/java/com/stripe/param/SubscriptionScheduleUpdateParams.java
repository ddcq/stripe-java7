...
public class SubscriptionScheduleUpdateParams extends ApiRequestParams {
  ...
  private SubscriptionScheduleUpdateParams(Billing billing, Object billingThresholds, CollectionMethod collectionMethod, String defaultPaymentMethod, String defaultSource, List<String> expand, Map<String, Object> extraParams, InvoiceSettings invoiceSettings, Map<String, String> metadata, List<Phase> phases, Boolean prorate, RenewalBehavior renewalBehavior, RenewalInterval renewalInterval) {
  ...
  public static class Builder {
    ...
    public SubscriptionScheduleUpdateParams build() {
      return new SubscriptionScheduleUpdateParams(this.billing, this.billingThresholds, this.collectionMethod, this.defaultPaymentMethod, this.defaultSource, this.expand, this.extraParams, this.invoiceSettings, this.metadata, this.phases, this.prorate, this.renewalBehavior, this.renewalInterval);
    }
  ...
  public static class Phase {
    ...
    private Phase(BigDecimal applicationFeePercent, String coupon, Object defaultTaxRates, Object endDate, Map<String, Object> extraParams, Long iterations, List<Plan> plans, Object startDate, BigDecimal taxPercent, Boolean trial, Object trialEnd) {
    ...
    public static class Builder {
       ...
       */
      public Phase build() {
        return new Phase(this.applicationFeePercent, this.coupon, this.defaultTaxRates, this.endDate, this.extraParams, this.iterations, this.plans, this.startDate, this.taxPercent, this.trial, this.trialEnd);
      }
    ...
    public static class Plan {
      ...
      private Plan(Object billingThresholds, Map<String, Object> extraParams, String plan, Long quantity, Object taxRates) {
        this.billingThresholds = billingThresholds;
        this.extraParams = extraParams;
        this.plan = plan;
