...
public class ValueListCreateParams extends ApiRequestParams {
  ...
  private ValueListCreateParams(String alias, List<String> expand, Map<String, Object> extraParams, ItemType itemType, Map<String, String> metadata, String name) {
    this.alias = alias;
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public ValueListCreateParams build() {
      return new ValueListCreateParams(this.alias, this.expand, this.extraParams, this.itemType, this.metadata, this.name);
    }
  ...
  public enum ItemType implements ApiRequestParams.EnumParam {
    ...
    CARD_BIN("card_bin"), @SerializedName("card_fingerprint")
    CARD_FINGERPRINT("card_fingerprint"), @SerializedName("case_sensitive_string")
    CASE_SENSITIVE_STRING("case_sensitive_string"), @SerializedName("country")
    COUNTRY("country"), @SerializedName("email")
    EMAIL("email"), @SerializedName("ip_address")
    IP_ADDRESS("ip_address"), @SerializedName("string")
    STRING("string");
