...
public class SessionCreateParams extends ApiRequestParams {
  ...
  private SessionCreateParams(BillingAddressCollection billingAddressCollection, String cancelUrl, String clientReferenceId, String customer, String customerEmail, List<String> expand, Map<String, Object> extraParams, List<LineItem> lineItems, Locale locale, PaymentIntentData paymentIntentData, List<PaymentMethodType> paymentMethodTypes, SubmitType submitType, SubscriptionData subscriptionData, String successUrl) {
  ...
  public static class Builder {
    ...
    public SessionCreateParams build() {
      return new SessionCreateParams(this.billingAddressCollection, this.cancelUrl, this.clientReferenceId, this.customer, this.customerEmail, this.expand, this.extraParams, this.lineItems, this.locale, this.paymentIntentData, this.paymentMethodTypes, this.submitType, this.subscriptionData, this.successUrl);
    }
  ...
  public static class SubscriptionData {
    ...
    private SubscriptionData(Map<String, Object> extraParams, List<Item> items, Map<String, String> metadata, Long trialEnd, Long trialPeriodDays) {
      this.extraParams = extraParams;
      this.items = items;
      this.metadata = metadata;
    ...
    public static class Builder {
      ...
      public SubscriptionData build() {
        return new SubscriptionData(this.extraParams, this.items, this.metadata, this.trialEnd, this.trialPeriodDays);
      }
