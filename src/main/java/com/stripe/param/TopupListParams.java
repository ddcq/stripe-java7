...
public class TopupListParams extends ApiRequestParams {
  ...
  private TopupListParams(Object amount, Object created, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String startingAfter, Status status) {
    this.amount = amount;
  ...
  public static class Builder {
    ...
    public TopupListParams build() {
      return new TopupListParams(this.amount, this.created, this.endingBefore, this.expand, this.extraParams, this.limit, this.startingAfter, this.status);
    }
     ...
     * TopupListParams#extraParams} for the field documentation.
     */
     ...
     * See {@link TopupListParams#extraParams} for the field documentation.
     */
  ...
  public static class Amount {
    ...
    private Amount(Map<String, Object> extraParams, Long gt, Long gte, Long lt, Long lte) {
      this.extraParams = extraParams;
      this.gt = gt;
      this.gte = gte;
      this.lt = lt;
    ...
    public static class Builder {
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * TopupListParams.Amount#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link TopupListParams.Amount#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public static class Created {
    ...
    public static class Builder {
       ...
       * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll`
       * call, and subsequent calls add additional key/value pairs to the original map. See {@link
       * TopupListParams.Created#extraParams} for the field documentation.
       */
      public Builder putExtraParam(String key, Object value) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
       ...
       * Add all map key/value pairs to `extraParams` map. A map is initialized for the first
       * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
       * See {@link TopupListParams.Created#extraParams} for the field documentation.
       */
      public Builder putAllExtraParam(Map<String, Object> map) {
        if (this.extraParams == null) {
          this.extraParams = new HashMap<>();
  ...
  public enum Status implements ApiRequestParams.EnumParam {
    ...
    CANCELED("canceled"), @SerializedName("failed")
    FAILED("failed"), @SerializedName("pending")
    PENDING("pending"), @SerializedName("succeeded")
    SUCCEEDED("succeeded");
