...
public class BankAccountUpdateOnCustomerParams extends ApiRequestParams {
  ...
  private BankAccountUpdateOnCustomerParams(String accountHolderName, AccountHolderType accountHolderType, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata) {
  ...
  public static class Builder {
    ...
    public BankAccountUpdateOnCustomerParams build() {
      return new BankAccountUpdateOnCustomerParams(this.accountHolderName, this.accountHolderType, this.expand, this.extraParams, this.metadata);
    }
