...
public class PaymentIntentConfirmParams extends ApiRequestParams {
  ...
  private PaymentIntentConfirmParams(List<String> expand, Map<String, Object> extraParams, Object offSession, String paymentMethod, PaymentMethodOptions paymentMethodOptions, String receiptEmail, String returnUrl, Boolean savePaymentMethod, SetupFutureUsage setupFutureUsage, Object shipping, String source) {
    this.expand = expand;
