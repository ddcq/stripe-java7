...
public class AuthorizationListParams extends ApiRequestParams {
  ...
  private AuthorizationListParams(String card, String cardholder, Object created, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String startingAfter, Status status) {
    this.card = card;
  ...
  public static class Builder {
    ...
    public AuthorizationListParams build() {
      return new AuthorizationListParams(this.card, this.cardholder, this.created, this.endingBefore, this.expand, this.extraParams, this.limit, this.startingAfter, this.status);
    }
  ...
  public enum Status implements ApiRequestParams.EnumParam {
    ...
    CLOSED("closed"), @SerializedName("pending")
    PENDING("pending"), @SerializedName("reversed")
    REVERSED("reversed");
