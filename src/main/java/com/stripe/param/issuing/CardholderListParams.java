...
public class CardholderListParams extends ApiRequestParams {
  ...
  private CardholderListParams(Object created, String email, String endingBefore, List<String> expand, Map<String, Object> extraParams, Boolean isDefault, Long limit, String phoneNumber, String startingAfter, Status status, Type type) {
  ...
  public static class Builder {
    ...
    public CardholderListParams build() {
      return new CardholderListParams(this.created, this.email, this.endingBefore, this.expand, this.extraParams, this.isDefault, this.limit, this.phoneNumber, this.startingAfter, this.status, this.type);
    }
  ...
  public enum Status implements ApiRequestParams.EnumParam {
    ...
    ACTIVE("active"), @SerializedName("blocked")
    BLOCKED("blocked"), @SerializedName("inactive")
    INACTIVE("inactive");
