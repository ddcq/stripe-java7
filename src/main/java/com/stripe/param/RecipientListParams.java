...
public class RecipientListParams extends ApiRequestParams {
  ...
  private RecipientListParams(Object created, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String startingAfter, Type type, Boolean verified) {
  ...
  public static class Builder {
    ...
    public RecipientListParams build() {
      return new RecipientListParams(this.created, this.endingBefore, this.expand, this.extraParams, this.limit, this.startingAfter, this.type, this.verified);
    }
  ...
  public enum Type implements ApiRequestParams.EnumParam {
    ...
    CORPORATION("corporation"), @SerializedName("individual")
