...
public class PaymentIntentCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public PaymentIntentCreateParams build() {
      return new PaymentIntentCreateParams(this.amount, this.applicationFeeAmount, this.captureMethod, this.confirm, this.confirmationMethod, this.currency, this.customer, this.description, this.expand, this.extraParams, this.metadata, this.offSession, this.onBehalfOf, this.paymentMethod, this.paymentMethodOptions, this.paymentMethodTypes, this.receiptEmail, this.returnUrl, this.savePaymentMethod, this.setupFutureUsage, this.shipping, this.source, this.statementDescriptor, this.transferData, this.transferGroup);
    }
  ...
  public static class PaymentMethodOptions {
    ...
    public static class Card {
      ...
      public enum RequestThreeDSecure implements ApiRequestParams.EnumParam {
        ...
        AUTOMATIC("automatic"), @SerializedName("challenge_only")
