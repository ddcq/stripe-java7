...
public class SkuCreateParams extends ApiRequestParams {
  ...
  private SkuCreateParams(Boolean active, Map<String, String> attributes, String currency, List<String> expand, Map<String, Object> extraParams, String id, String image, Inventory inventory, Map<String, String> metadata, PackageDimensions packageDimensions, Long price, String product) {
    this.active = active;
