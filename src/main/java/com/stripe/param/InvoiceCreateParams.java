...
public class InvoiceCreateParams extends ApiRequestParams {
  ...
  private InvoiceCreateParams(Long applicationFeeAmount, Boolean autoAdvance, Billing billing, CollectionMethod collectionMethod, Object customFields, String customer, Long daysUntilDue, String defaultPaymentMethod, String defaultSource, List<String> defaultTaxRates, String description, Long dueDate, List<String> expand, Map<String, Object> extraParams, String footer, Map<String, String> metadata, String statementDescriptor, String subscription, BigDecimal taxPercent, TransferData transferData) {
