...
public class BankAccountUpdateOnAccountParams extends ApiRequestParams {
  ...
  private BankAccountUpdateOnAccountParams(String accountHolderName, ApiRequestParams.EnumParam accountHolderType, Boolean defaultForCurrency, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata) {
  ...
  public static class Builder {
    ...
    public BankAccountUpdateOnAccountParams build() {
      return new BankAccountUpdateOnAccountParams(this.accountHolderName, this.accountHolderType, this.defaultForCurrency, this.expand, this.extraParams, this.metadata);
    }
     ...
     * BankAccountUpdateOnAccountParams#extraParams} for the field documentation.
     */
     ...
     * See {@link BankAccountUpdateOnAccountParams#extraParams} for the field documentation.
     */
