...
public class PaymentMethodCreateParams extends ApiRequestParams {
  ...
  private PaymentMethodCreateParams(BillingDetails billingDetails, Object card, String customer, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata, String paymentMethod, Type type) {
  ...
  public static class CardDetails {
    ...
    private CardDetails(String cvc, Long expMonth, Long expYear, Map<String, Object> extraParams, String number) {
      this.cvc = cvc;
