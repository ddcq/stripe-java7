...
public class SubscriptionItemUpdateParams extends ApiRequestParams {
  ...
  private SubscriptionItemUpdateParams(Object billingThresholds, List<String> expand, Map<String, Object> extraParams, Map<String, String> metadata, PaymentBehavior paymentBehavior, String plan, Boolean prorate, Long prorationDate, Long quantity, Object taxRates) {
  ...
  public static class Builder {
    ...
    public SubscriptionItemUpdateParams build() {
      return new SubscriptionItemUpdateParams(this.billingThresholds, this.expand, this.extraParams, this.metadata, this.paymentBehavior, this.plan, this.prorate, this.prorationDate, this.quantity, this.taxRates);
    }
