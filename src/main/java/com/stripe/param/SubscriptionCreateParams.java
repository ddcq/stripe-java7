...
public class SubscriptionCreateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public SubscriptionCreateParams build() {
      return new SubscriptionCreateParams(this.applicationFeePercent, this.backdateStartDate, this.billing, this.billingCycleAnchor, this.billingThresholds, this.cancelAt, this.cancelAtPeriodEnd, this.collectionMethod, this.coupon, this.customer, this.daysUntilDue, this.defaultPaymentMethod, this.defaultSource, this.defaultTaxRates, this.expand, this.extraParams, this.items, this.metadata, this.offSession, this.paymentBehavior, this.prorate, this.taxPercent, this.transferData, this.trialEnd, this.trialFromPlan, this.trialPeriodDays);
    }
  ...
  public static class Item {
    ...
    private Item(Object billingThresholds, Map<String, Object> extraParams, Map<String, String> metadata, String plan, Long quantity, Object taxRates) {
      this.billingThresholds = billingThresholds;
      this.extraParams = extraParams;
      this.metadata = metadata;
      this.plan = plan;
    ...
    public static Builder builder() {
      return new com.stripe.param.SubscriptionCreateParams.Item.Builder();
    }
    ...
    public static class BillingThresholds {
      ...
      public static Builder builder() {
        return new com.stripe.param.SubscriptionCreateParams.Item.BillingThresholds.Builder();
      }
