...
public class PlanCreateParams extends ApiRequestParams {
  ...
  private PlanCreateParams(Boolean active, AggregateUsage aggregateUsage, Long amount, BillingScheme billingScheme, String currency, List<String> expand, Map<String, Object> extraParams, String id, Interval interval, Long intervalCount, Map<String, String> metadata, String nickname, Object product, List<Tier> tiers, TiersMode tiersMode, TransformUsage transformUsage, Long trialPeriodDays, UsageType usageType) {
    this.active = active;
  ...
  public static class Builder {
    ...
    public PlanCreateParams build() {
      return new PlanCreateParams(this.active, this.aggregateUsage, this.amount, this.billingScheme, this.currency, this.expand, this.extraParams, this.id, this.interval, this.intervalCount, this.metadata, this.nickname, this.product, this.tiers, this.tiersMode, this.transformUsage, this.trialPeriodDays, this.usageType);
    }
  ...
  public static class Product {
    ...
    private Product(Boolean active, Map<String, Object> extraParams, String id, Map<String, String> metadata, String unitLabel) {
      this.active = active;
      this.extraParams = extraParams;
      this.id = id;
      this.metadata = metadata;
