...
public class SubscriptionListParams extends ApiRequestParams {
  ...
  private SubscriptionListParams(Billing billing, CollectionMethod collectionMethod, Object created, Object currentPeriodEnd, Object currentPeriodStart, String customer, String endingBefore, List<String> expand, Map<String, Object> extraParams, Long limit, String plan, String startingAfter, Status status) {
  ...
  public static class Builder {
    ...
    public SubscriptionListParams build() {
      return new SubscriptionListParams(this.billing, this.collectionMethod, this.created, this.currentPeriodEnd, this.currentPeriodStart, this.customer, this.endingBefore, this.expand, this.extraParams, this.limit, this.plan, this.startingAfter, this.status);
    }
  ...
  public static class CurrentPeriodEnd {
    ...
    private CurrentPeriodEnd(Map<String, Object> extraParams, Long gt, Long gte, Long lt, Long lte) {
      this.extraParams = extraParams;
      this.gt = gt;
      this.gte = gte;
      this.lt = lt;
  ...
  public static class CurrentPeriodStart {
    ...
    private CurrentPeriodStart(Map<String, Object> extraParams, Long gt, Long gte, Long lt, Long lte) {
      this.extraParams = extraParams;
      this.gt = gt;
      this.gte = gte;
      this.lt = lt;
