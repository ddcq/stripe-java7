...
public class ProductCreateParams extends ApiRequestParams {
  ...
  private ProductCreateParams(Boolean active, List<String> attributes, String caption, List<String> deactivateOn, String description, List<String> expand, Map<String, Object> extraParams, String id, List<String> images, Map<String, String> metadata, String name, PackageDimensions packageDimensions, Boolean shippable, String statementDescriptor, Type type, String unitLabel, String url) {
    this.active = active;
