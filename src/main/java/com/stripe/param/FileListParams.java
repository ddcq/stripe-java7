...
public class FileListParams extends ApiRequestParams {
  ...
  private FileListParams(Object created, String endingBefore, List<String> expand, Long limit, Purpose purpose, String startingAfter) {
  ...
  public static class Builder {
    ...
    public FileListParams build() {
      return new FileListParams(this.created, this.endingBefore, this.expand, this.limit, this.purpose, this.startingAfter);
    }
  ...
  public enum Purpose implements ApiRequestParams.EnumParam {
    ...
    BUSINESS_ICON("business_icon"), @SerializedName("business_logo")
    BUSINESS_LOGO("business_logo"), @SerializedName("customer_signature")
    CUSTOMER_SIGNATURE("customer_signature"), @SerializedName("dispute_evidence")
    DISPUTE_EVIDENCE("dispute_evidence"), @SerializedName("finance_report_run")
    FINANCE_REPORT_RUN("finance_report_run"), @SerializedName("identity_document")
    IDENTITY_DOCUMENT("identity_document"), @SerializedName("pci_document")
    PCI_DOCUMENT("pci_document"), @SerializedName("sigma_scheduled_query")
    SIGMA_SCHEDULED_QUERY("sigma_scheduled_query"), @SerializedName("tax_document_user_upload")
