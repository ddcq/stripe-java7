...
public class OrderCreateParams extends ApiRequestParams {
  ...
  private OrderCreateParams(String coupon, String currency, String customer, String email, List<String> expand, Map<String, Object> extraParams, List<Item> items, Map<String, String> metadata, Shipping shipping) {
    this.coupon = coupon;
  ...
  public static class Builder {
    ...
    public OrderCreateParams build() {
      return new OrderCreateParams(this.coupon, this.currency, this.customer, this.email, this.expand, this.extraParams, this.items, this.metadata, this.shipping);
    }
