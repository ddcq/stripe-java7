...
public class SetupIntentConfirmParams extends ApiRequestParams {
  ...
  private SetupIntentConfirmParams(List<String> expand, Map<String, Object> extraParams, String paymentMethod, PaymentMethodOptions paymentMethodOptions, String returnUrl) {
    this.expand = expand;
  ...
  public static class Builder {
    ...
    public SetupIntentConfirmParams build() {
      return new SetupIntentConfirmParams(this.expand, this.extraParams, this.paymentMethod, this.paymentMethodOptions, this.returnUrl);
    }
