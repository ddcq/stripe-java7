...
public class SourceCreateParams extends ApiRequestParams {
  ...
  private SourceCreateParams(Long amount, String currency, String customer, List<String> expand, Map<String, Object> extraParams, Flow flow, Map<String, String> metadata, String originalSource, Owner owner, Receiver receiver, Redirect redirect, SourceOrder sourceOrder, String statementDescriptor, String token, String type, Usage usage) {
    this.amount = amount;
  ...
  public static class Builder {
    ...
    public SourceCreateParams build() {
      return new SourceCreateParams(this.amount, this.currency, this.customer, this.expand, this.extraParams, this.flow, this.metadata, this.originalSource, this.owner, this.receiver, this.redirect, this.sourceOrder, this.statementDescriptor, this.token, this.type, this.usage);
    }
  ...
  public static class Receiver {
    ...
    private Receiver(Map<String, Object> extraParams, RefundAttributesMethod refundAttributesMethod) {
      this.extraParams = extraParams;
