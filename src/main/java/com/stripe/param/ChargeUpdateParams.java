...
public class ChargeUpdateParams extends ApiRequestParams {
  ...
  private ChargeUpdateParams(String customer, String description, List<String> expand, Map<String, Object> extraParams, FraudDetails fraudDetails, Map<String, String> metadata, String receiptEmail, Shipping shipping, String transferGroup) {
