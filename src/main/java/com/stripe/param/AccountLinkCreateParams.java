...
public class AccountLinkCreateParams extends ApiRequestParams {
  ...
  private AccountLinkCreateParams(String account, Collect collect, List<String> expand, Map<String, Object> extraParams, String failureUrl, String successUrl, String type) {
