...
public class InvoiceUpcomingParams extends ApiRequestParams {
  ...
  private InvoiceUpcomingParams(String coupon, String customer, List<String> expand, Map<String, Object> extraParams, List<InvoiceItem> invoiceItems, String subscription, Object subscriptionBillingCycleAnchor, Boolean subscriptionCancelAtPeriodEnd, Boolean subscriptionCancelNow, Object subscriptionDefaultTaxRates, List<SubscriptionItem> subscriptionItems, Boolean subscriptionProrate, Long subscriptionProrationDate, Long subscriptionStartDate, BigDecimal subscriptionTaxPercent, Object subscriptionTrialEnd, Boolean subscriptionTrialFromPlan) {
    this.coupon = coupon;
  ...
  public static class InvoiceItem {
    ...
    private InvoiceItem(Long amount, String currency, String description, Boolean discountable, Map<String, Object> extraParams, String invoiceitem, Map<String, String> metadata, Period period, Long quantity, Object taxRates, Long unitAmount) {
      this.amount = amount;
    ...
    public static class Builder {
      ...
      public InvoiceItem build() {
        return new InvoiceItem(this.amount, this.currency, this.description, this.discountable, this.extraParams, this.invoiceitem, this.metadata, this.period, this.quantity, this.taxRates, this.unitAmount);
      }
  ...
  public static class SubscriptionItem {
    ...
    private SubscriptionItem(Object billingThresholds, Boolean clearUsage, Boolean deleted, Map<String, Object> extraParams, String id, Map<String, String> metadata, String plan, Long quantity, Object taxRates) {
