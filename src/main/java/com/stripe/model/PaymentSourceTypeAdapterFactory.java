...
public class PaymentSourceTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
    ...
    final TypeAdapter<PaymentSource> paymentSourceAdapter = gson.getDelegateAdapter(this, TypeToken.get(PaymentSource.class));
    final TypeAdapter<Account> accountAdapter = gson.getDelegateAdapter(this, TypeToken.get(Account.class));
    ...
    TypeAdapter<PaymentSource> resultCustomTypeAdapter = new TypeAdapter<PaymentSource>() {
      @Override
