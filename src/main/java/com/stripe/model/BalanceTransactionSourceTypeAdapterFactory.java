...
public class BalanceTransactionSourceTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
    ...
    final TypeAdapter<BalanceTransactionSource> balanceTransactionSourceAdapter = gson.getDelegateAdapter(this, TypeToken.get(BalanceTransactionSource.class));
    final TypeAdapter<ApplicationFee> applicationFeeAdapter = gson.getDelegateAdapter(this, TypeToken.get(ApplicationFee.class));
    final TypeAdapter<Charge> chargeAdapter = gson.getDelegateAdapter(this, TypeToken.get(Charge.class));
    final TypeAdapter<ConnectCollectionTransfer> connectCollectionTransferAdapter = gson.getDelegateAdapter(this, TypeToken.get(ConnectCollectionTransfer.class));
    final TypeAdapter<Dispute> disputeAdapter = gson.getDelegateAdapter(this, TypeToken.get(Dispute.class));
    final TypeAdapter<FeeRefund> feeRefundAdapter = gson.getDelegateAdapter(this, TypeToken.get(FeeRefund.class));
    final TypeAdapter<Authorization> authorizationAdapter = gson.getDelegateAdapter(this, TypeToken.get(Authorization.class));
    final TypeAdapter<Transaction> transactionAdapter = gson.getDelegateAdapter(this, TypeToken.get(Transaction.class));
    final TypeAdapter<Payout> payoutAdapter = gson.getDelegateAdapter(this, TypeToken.get(Payout.class));
    final TypeAdapter<PlatformTaxFee> platformTaxFeeAdapter = gson.getDelegateAdapter(this, TypeToken.get(PlatformTaxFee.class));
    final TypeAdapter<Refund> refundAdapter = gson.getDelegateAdapter(this, TypeToken.get(Refund.class));
    final TypeAdapter<ReserveTransaction> reserveTransactionAdapter = gson.getDelegateAdapter(this, TypeToken.get(ReserveTransaction.class));
    final TypeAdapter<Topup> topupAdapter = gson.getDelegateAdapter(this, TypeToken.get(Topup.class));
    final TypeAdapter<Transfer> transferAdapter = gson.getDelegateAdapter(this, TypeToken.get(Transfer.class));
    final TypeAdapter<TransferReversal> transferReversalAdapter = gson.getDelegateAdapter(this, TypeToken.get(TransferReversal.class));
    TypeAdapter<BalanceTransactionSource> resultCustomTypeAdapter = new TypeAdapter<BalanceTransactionSource>() {
      @Override
